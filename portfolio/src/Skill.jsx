function Skill() {
    ...
    return (
        <div className="flex flex-wrap justify-center gap-2">
            {skillList.map((skill) => {
                return (
                    <div key={skill} className="bg-white border-gray-300 border rounded-full px-4 py-2 shadow-sm text-gray-700 text-sm font-medium hover:simple-transition hover:shadow-md hover:transition-transform hover:transform hover:scale-105">
                        {skill}
                    </div>
                );
            })}
